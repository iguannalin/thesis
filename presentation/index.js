window.addEventListener("load", () => {
  ...
  function createWindow() {
    ...
    <body><div id="overlay"></div> <div id="container" data-info=${btoa(info)}></div></body><script>let container = document.getElementById('container'); if (container.dataset.info) container.innerHTML = atob(container.dataset.info); container.style.backgroundColor = ${color}</script></html>`;
